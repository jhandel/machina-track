...
import { MapPin, Building2, Ruler, Package, Wrench, Users } from "lucide-react";
          ...
          <TabsContent value="locations" className="space-y-4">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Manage the physical locations in your facility where equipment
                  and tools are stored.
                </CardDescription>
              </CardHeader>
              <CardContent>
                <LocationsTab />
          ...
          <TabsContent value="metrology-types" className="space-y-4">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Define the types of metrology tools used in your quality
                  control processes.
                </CardDescription>
              </CardHeader>
              <CardContent>
          ...
          <TabsContent value="consumable-types" className="space-y-4">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Define the types of consumables used in your machining
                  operations.
                </CardDescription>
              </CardHeader>
              <CardContent>
